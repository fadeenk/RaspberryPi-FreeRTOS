...
kernel.elf: LDFLAGS += -L "/usr/local/bin/gcc-arm-none-eabi-7-2018-q2-update/lib/gcc/arm-none-eabi/7.3.1" -lgcc
kernel.elf: LDFLAGS += -L "/usr/local/bin/gcc-arm-none-eabi-7-2018-q2-update/arm-none-eabi/lib" -lc
kernel.elf: $(OBJECTS)
